...
The `?fixture=contact` view isolates attachment to a curved surface using [core-generated geometry and support poses](../../assets/proportions/README.md). It uses the production fly and camera without inventing neural movement. Fixed animation inspection validates pose binding; actual landing and food behavior require recorded attempts.
