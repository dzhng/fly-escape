...
def prepare(graph_dir, output, version=2):
    ...
    baseline_relative='specs/retinal-vision/assets/08/confirmation/freeze.json' if version == 2 else 'specs/retinal-vision/assets/08-reslice/confirmation-08-v2/freeze.json'
