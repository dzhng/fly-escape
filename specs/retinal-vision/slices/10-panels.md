...
**Status:** passed. Controlled and actual physical recorded RGB render exactly for all sixteen selections, rewind, black/absent input, camera changes and scrolling. The user-requested horizontal fly strip is integrated with keyboard access and automatic selected-card visibility. See [physical evidence](../assets/10/physical/README.md) and [roster comparison](../assets/10/horizontal-roster/README.md). Final full-round resource gates remain in slice 11.
