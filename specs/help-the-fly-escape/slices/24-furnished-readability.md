...
The [domestic layout pass](../assets/evidence/24/domestic-layouts/README.md) implements the user's larger-room and ordinary-doorway corrections. Native furniture keeps its size; frames leave core openings clear. Current composed issues are sparse room identity, doorway overlap at whole-house framing and the unrecognizable open-window target.
