...
First resolve the [new second-house refinement failure](assets/evidence/17/full-retry-harness/README.md#newly-captured-failure), captured during sustained retries with seed `1744322718178062846`. Preserve bounded contact work and safe physical poses; do not raise tolerances/budgets or bypass the error. Then finish the two-level game through [30 — Household objects and hazards](slices/30-household-objects.md), then campaign calibration and final release gates. Exactly two crafted levels, twenty flies, one fan maximum, object discovery and meaningful eating remain the target. Do not return to chained-fan puzzles or the rejected microscopic contact-certificate program.
