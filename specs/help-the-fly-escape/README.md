...
**Latest user-requested presentation:** per-fly zoom sizing and right-drag/reset camera, 5× wing clip, skull/escape icons, exit glow, measured 3D soma view and all-group traces are implemented. Camera and science browser suites pass; [evidence and limits](assets/evidence/30/reading-flies/README.md). The optional [geometry-input spike](assets/evidence/30/geometry-vision/README.md) showed no clear benefit and remains out of production. The subsequent firing-readout integration and normal-UI checks are recorded below.
