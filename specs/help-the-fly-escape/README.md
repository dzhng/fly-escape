...
**Current pickup:** rerun sparse food placements with the [contact turn repair](assets/evidence/20/contact-turn/README.md) before balance changes. A blocked translating sweep now retains an independently clear brain-requested turn, including floor-arc clearance and reachable hazard handling. The original bottle reproduction moves beyond its former fixed point. Pre-fix [sparse-food results](assets/evidence/15/sparse-food-playtest/README.md) do not establish placement advantage. The optional [repellent search](assets/evidence/33/repellent-object/README.md) is complete and must not be reopened as a release blocker.

**Latest placement evidence:** [post-contact paired results](assets/evidence/15/food-after-contact/README.md) are complete: empty5/5/4, banana at final-room entrance2/2/5, banana beside exit4/4/4. Neither food layout beats the empty control on average; zero recorded food support contradicts blaming these losses on landing/feeding. Level1 now uses the allowed ten-minute timer; the quiet production replay matches four native escapes with zero underruns, but80.8seconds buffering and34ms frame-p95 leave release performance open. The [isolated banana direction comparison](assets/evidence/33/banana-direction/README.md) is complete and root-reproduced: early movement/alignment favors the nearby scent in both mirrored conditions. It does not support labeling banana repellent or blaming house losses on feeding; it also does not prove useful distant recruitment. Next work is level/object-placement control against the empty baseline, with neural signs and gains frozen. The [single-fan control](assets/evidence/15/single-fan-control/README.md) is also complete: fan alone2/7/3, fan+banana3/2/7, equal means. First-level stars are provisionally1/4/8; this is not held-out balance acceptance. All diagnostic jobs from this checkpoint are terminal.
