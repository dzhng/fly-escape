...
The exterior, authored warm materials, native fruit colours, wall lights/windows and wall plants are integrated. User feedback now requires realistic room proportions and ordinary doorways. Both maps have been reauthored around living rooms, kitchens, halls and side rooms; door frames preserve a 90 cm clear passage under a 2.05 m header. The larger house invalidates previous campaign calibration. Preserve native furniture and fly sizes. [Browser layout inspection](assets/evidence/24/domestic-layouts/README.md) passes proportions and traversal, with room identity now supplied by the [kitchen, study and bed integration](assets/evidence/22/domestic-furnishings/README.md). [Open French-window exits](assets/evidence/24/open-exits/README.md) now dress the physical openings; detailed surfaces and exit identity remain open. Establish reliable reference solutions and meaningful food dependence on the new geometry while finishing room identity and exit presentation. The shared fan now uses a 3 m/s peak wind after native contact checks. [First-level evidence](assets/evidence/15/fan-strength/README.md) includes 17 escapes, 3 earned stars and actual second-level unlock in Chrome. The second route and food dependence remain the main gameplay work. Timed wall sliding now preserves sideways travel and replay bends; the focused core gates pass. The current furnished second-level diagnostic reaches three escapes versus zero with no tools, and first-level browser replay reaches eighteen escapes with earned progression. Continue second-route and food tuning; no pathfinding or neural-output changes.
