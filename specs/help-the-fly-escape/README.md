...
Continue [20 — furnishing and food contact](slices/20-furnished-contact.md) by measuring continuous supported paths with the [prepared conservative native envelope](assets/evidence/20/support-path-feasibility/native-envelope/preparation.md). The smaller shape preserves the reference hull within numerical roundoff and is a candidate for movement tests, not an adopted body. Compare path construction and support against the full hull before expanding the event solver. Preserve containment, visible contact, world scale and numerical tolerance. The [path feasibility evidence](assets/evidence/20/support-path-feasibility/README.md) resolves local face walks and an edge handoff; global competing contacts and general translating rotation remain unaccepted.
