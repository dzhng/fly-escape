...
- **Use outcome badges without an extra departure simulation — sound, medium confidence.** The user allowed an escape icon or a scripted departure. A green check distinguishes escape while retaining the recorded terminal pose; a skull marks zapper death. Both use the displayed fly scale. This avoids making the camera follow a second, unrecorded flight path.
