...
Food fruit combines odor and an edible landing surface; scent-only objects do not replenish life. Odor and light objects must exercise measured graph-mediated pathways. Include a visible zapper in the second level, at most one per level, clear of spawn and the only exit. Predatory hazards must be visible and avoidable, with truthful terminal labels; do not use random deaths to fake difficulty.
