...
const output = process.env.LIFECYCLE_EVIDENCE_DIR
  ? pathToFileURL(resolve(process.env.LIFECYCLE_EVIDENCE_DIR) + "/")
  : new URL("../../specs/done/help-the-fly-escape/assets/evidence/04/", import.meta.url);
